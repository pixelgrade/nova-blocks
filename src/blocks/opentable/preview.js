...
class OpenTablePreview extends Component {
	...
	render() {
		...
		const html = `<div class="novablocks-opentable ${classNames}">` +
		             `<script type='text/javascript' src='https://www.opentable.com/widget/reservation/loader?rid=${restaurantId}&type=standard&theme=${layoutForm}&iframe=false&overlay=false&domain=com&lang=${language}'></script>` +
