...
function novablocks_get_media_attributes_config() {
	...
	$space_and_sizing_attributes = novablocks_get_attributes_from_json( 'packages/block-editor/src/components/hooks/with-space-and-sizing-controls/attributes.json' );
