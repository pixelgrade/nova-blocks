<?php
/**
 * NovaBlocks_Comments_Moderate Class
 *
 * @author   Pixelgrade
 * @package  NovaBlocks
 * @since    1.9.0
...
if ( ! class_exists( 'NovaBlocks_Comments_Moderate' ) ) {

	/**
	 * The NovaBlocks_Comments_Moderate class
	 */
	class NovaBlocks_Comments_Moderate {

		/**
		 * Instance of this class (the singleton pattern).
		 * @since    1.9.0
		 * @var      NovaBlocks_Comments_Moderate
		 */
		...
		/**
		 * Main NovaBlocks_Comments_Moderate Instance
		 *
		 * Ensures only one instance of NovaBlocks_Comments_Moderate is loaded or can be loaded.
		 *
		 * @since  1.9.0
		 * @static
		 *
		 * @return NovaBlocks_Comments_Moderate Main NovaBlocks_Comments_Moderate instance
		 */
