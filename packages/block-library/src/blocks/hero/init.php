...
if ( ! function_exists( 'novablocks_render_hero_block' ) ) {
	...
	function novablocks_render_hero_block( $attributes, $content ) {
		...
		>
			...
			<div
				class="novablocks-hero__foreground novablocks-doppler__foreground novablocks-u-content-padding novablocks-u-content-align">
				<div
					class="novablocks-hero__inner-container wp-block-group__inner-container novablocks-u-content-width">
