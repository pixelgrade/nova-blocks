...
function novablocks_register_block_patterns() {
	...
	register_block_pattern_category(
		'novablocks/media-cards',
		array( 'label' => __( 'Media Cards', '__plugin_txtd' ) )
	);

	register_block_pattern(
		'novablocks/media-card-pattern-1',
		array(
			'title'       => __( 'Testimonials', '__plugin_txtd' ),
...
<!-- /wp:novablocks/supernova -->',
			'categories'  => array( 'novablocks/media-cards' )
		)
	);
}
