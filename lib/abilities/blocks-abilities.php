		...
		'pixelgrade/describe-block'     => [
			...
			'output_schema'       => novablocks_agent_blocks_output_schema(
				[
					...
					'body_template'   => [
						'type'        => [ 'string', 'null' ],
						'description' => 'Harness-generated canonical inner-HTML skeleton for a curated static block; null only for an uncurated static block.',
					],
